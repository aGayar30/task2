...
public class Tesla extends Car {
    ...
    public Tesla(String model, int year, String motor, double battery, double km_on_recharge, double km_for_full_charge) {
    ...
    public Tesla(String model, int year, double battery, double km_on_recharge, double km_for_full_charge) {
        super(model, year);
        this.battery = battery;
        this.km_on_recharge = km_on_recharge;
        this.km_for_full_charge = km_for_full_charge;
    ...
    public Tesla(String model, double battery) {
        super(model);
        this.battery = battery;
    }
